            ...
            <div class="card-body">
                ...
                <form class="row g-3" action="/tableAbsensi/{{$id}}" method="post">
                    ...
                    <div class="col-12">
                        ...
                        <input type="time" name="start_time" value="{{$start_time}}" class="form-control" id="inputEmail4">
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label">Batas Keterlambatan Absen Masuk</label>
                        <input type="time" name="batas_start_time" value="{{$batas_start_time}}" class="form-control" id="inputEmail4">
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label">Absen Pulang</label>
                        <input type="time" name="end_time" value="{{$end_time}}" class="form-control" id="inputEmail4">
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label">Batas Keterlambatan Absen Pulang</label>
                        <input type="time" name="batas_end_time" value="{{$batas_end_time}}" class="form-control" id="inputEmail4">
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label">Jabatan</label>
                        <input type="input" name="jabatan" value="{{$jabatan}}" class="form-control" id="inputEmail4" readonly>
                    </div>
