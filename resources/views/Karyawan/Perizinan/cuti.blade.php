...
<!-- End Page Title -->
@if($data3=='[{"status":"Pending-cuti"}]' )
<h5 class="card-title">Form Cuti Anda Menunggu Konfirmasi</h5>
@else
<section class="section dashboard">
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Form Absensi Cuti</h5>
                ...
                <form class="row g-3" action="/tableLogKehadiranSakit/create/store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="status" value="Pending-cuti" class="form-control" id="inputEmail4" hidden>
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label"> Upload Surat Izin</label>
                        <h1>Surat Cuti Dapat Didapatkan Di Menu Pengajuan Surat</h1>
