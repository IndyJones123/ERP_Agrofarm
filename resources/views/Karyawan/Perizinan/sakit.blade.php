...
<section class="section dashboard">
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Form Izin Sakit</h5>
                ...
                <form class="row g-3" action="/tableLogKehadiran/create/store" method="post">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="status" value="Sakit-pending" class="form-control" id="inputEmail4" hidden>
                    </div>
                    <div class="col-12">
                        <label for="inputEmail4" class="form-label"> Upload Surat Dokter</label>
                        <input type="file" name="keterangan" value="" class="form-control" id="inputEmail4" required>
                    </div>
