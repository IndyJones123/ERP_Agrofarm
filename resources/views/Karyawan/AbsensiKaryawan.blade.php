...
@if($absen->jarak < $result) <h1>Anda Tidak Berada Pada Jarak Absensi</h1>
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="filter">
                                ...
                                @if('22:00:00'>$waktu && $data3!='[{"status":"Pending-cuti"}]' && $data3!='[{"status":"Pending-dinasluar"}]' && $data3!='[{"status":"Pending-sakit"}]' && $data3!='[{"status":"Pending-izin"}]' && $data3!='[{"status":"Terlambat"}]' && $data3!='[{"status":"Terlambats"}]' && $data3!='[{"status":"Hadir-1"}]' && $data3!='[{"status":"Hadir-2"}]' && $data3!='[{"status":"izin"}]' && $data3!='[{"status":"Libur"}]')
                                            ...
                                            @elseif($Absensi->start_time<$waktu && $data3=='[{"status":"Terlambat"}]' ) <a href=""><button type="submit" class="btn btn-warning">Anda Sudah Absen Terlambat Hari Ini</button></a>
                                                @elseif($Absensi->start_time<$waktu && $data3=='[{"status":"Hadir-2"}]' ) <a href=""><button type="submit" class="btn btn-success">Anda Sudah Absen Masuk Hari Ini</button></a>
                                                    @elseif($Absensi->start_time<$waktu && $data3=='[{"status":"Hadir-1"}]' ) <a href=""><button type="submit" class="btn btn-success">Anda Sudah Absen Masuk Hari Ini</button></a>
                                                        @else
                                                        <a href=""><button type="submit" class="btn btn-warning">Anda Berada Diluar Jangkauan Absensi</button></a>
