...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="index.html"><img src="assets2/img/AGROFARM EKSTERNAL.png"></a></h1>
                        ...
                        <ul>
                            <li>
                                ...
                                <div>
                                    ...
                                    <p>Membangun industri pangan untuk masyarakat dunia</p>
                                </div>
                            </li>
                            <li>
        ...
        <section id="clients" class="clients section-bg" ">
            ...
            <div class=" row">
                <center>
                    ...
                    <a href="/PTAgriPrimeInternational"><img src="assets2/img/AgriPrime.png" class="img-fluid" width="150" height="100" style="margin-left:50px;" alt=""></a>
                
                    <a href="PTAgrochem"><img src="assets2/img/Agrochem.png" class="img-fluid" width="150" height="100" style="margin-left:50px; alt=""></a>
                

                    <a href="PTSAP"><img src="assets2/img/SAP.png" class="img-fluid" width="150" height="100" style="margin-left:50px; alt=""></a>
        ...
        <section id="products" class="portfolio">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-mikro">
                        <img src="assets2/img/Product/LAKABA.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>LAKABA</h4>
                            <p>LAKABA</p>
                            <a href="assets2/img/Product/LAKABA.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="LAKABA"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-mikro">
                        <img src="assets2/img/Product/PALMIC.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>PALMIC</h4>
                            <p>PALMIC</p>
                            <a href="assets2/img/Product/PALMIC.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="PALMIC"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-mikro">
                        <img src="assets2/img/Product/INABOR-10.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>INABOR 10</h4>
                            <p>INABOR 10</p>
                            <a href="assets2/img/Product/INABOR-10.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="INABOR 10"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 portfolio-item filter-mikro">
                        <img src="assets2/img/Product/MICBA.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>MICBA</h4>
                            <p>MICBA</p>
                            <a href="assets2/img/Product/MICBA.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="MICBA"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 portfolio-item filter-npk">
                        <img src="assets2/img/Product/ANR-30.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>ANR-30 PLUS TE</h4>
                            <p>ANR-30 PLUS TE</p>
                            <a href="assets2/img/Product/ANR-30.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="ANR-30 PLUS TE"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 portfolio-item filter-hayati">
                        <img src="assets2/img/Product/MYCOPALM.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>MYCOPALM</h4>
                            <p>MYCOPALM</p>
                            <a href="assets2/img/Product/MYCOGROW.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="MYCOPALM"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-6 portfolio-item filter-hayati">
                        <img src="assets2/img/Product/MYCOGROW.png" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <h4>MYCOPALM</h4>
                            <p>MYCOPALM</p>
                            <a href="assets2/img/Product/MYCOGROW.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="MYCOPALM"><i class="bx bx-plus"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-organik">
                        ...
                        <div class="portfolio-info">
                            <h4>HAYME</h4>
                            <p>HAYME</p>
                            <a href="assets2/img/Product/MYCOGROW.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="HAYME"><i class="bx bx-plus"></i></a>
                            <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                        </div>
                    </div>
